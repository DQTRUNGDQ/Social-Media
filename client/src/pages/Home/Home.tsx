  ...
  return (
    <div className='home-content'>
      <div className='essay-options'>
        <div className='option-item'>Dành cho bạn</div>
        <div className='option-item'>Đang theo dõi</div>
      </div>
      ...
      <div className='essay-content'>
        ...
        <div className='post-content'>
          <div className='content-detail'>
            <span>Bắt đầu một chủ đề...</span>
          </div>
          <div className='upload-methods'>
            <div className='type-reply'>
              <button>
                ...
                <span>Mọi người có thể phản hồi</span>
              </button>
            </div>
